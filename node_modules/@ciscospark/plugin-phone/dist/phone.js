...
var Phone = _sparkCore.SparkPlugin.extend({
  ...
  _onLocusEvent: function _onLocusEvent(event) {
    if ((0, _stateParsers.shouldRing)(event) && !this.emittedCalls.has(event.data.locus)) {
      if (!(0, _get3.default)(this, 'config.enableExperimentalGroupCallingSupport') && !(0, _stateParsers.isCall)(event.data.locus)) {
        return;
      }
